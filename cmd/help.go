...
func Help() {
	...
	fmt.Println(color.Secondary + "make project" + color.Reset + "        => y siga las instrucciones para crea un nuevo proyecto")
	fmt.Println("")
	...
	fmt.Println(color.Secondary + "make merge:upstream" + color.Reset + " => hace un merge con la rama upstream (solo si creaste el proyecto como fork)")
	fmt.Println("")
